...
namespace FluidSimulation
{
    ...
    namespace Lagrangian2d
    {
        ...
        void ParticleSystem2d::setContainerSize(glm::vec2 containerCorner, glm::vec2 containerSize)
        {
            glm::vec2 lower = containerCorner;
            glm::vec2 upper = containerSize;
            // Ӧ������
        ...
        uint32_t ParticleSystem2d::getBlockIdByPosition(glm::vec2 position)
        {
            ...
            glm::vec2 deltaPos = position - lowerBound;
            uint32_t c = floor(deltaPos.x / blockSize.x);
            uint32_t r = floor(deltaPos.y / blockSize.y);
